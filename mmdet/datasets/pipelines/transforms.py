...
class RandomFlip(object):
    ...
    def bbox_flip(self, bboxes, img_shape, direction):
        ...
        return flipped
    def ratio_flip(self, ratios, direction):


        assert ratios.shape[-1] % 2 == 0
        flipped = ratios.copy()
        if direction == 'horizontal':
            flipped[..., 0::2] = 1 - ratios[..., 0::2]
            flipped[..., 1::2] = 1 - ratios[..., 1::2]
        elif direction == 'vertical':
            flipped[..., 0::2] = 1 - ratios[..., 0::2]
            flipped[..., 1::2] = 1 - ratios[..., 1::2]
        elif direction == 'diagonal':
            flipped[..., 0::2] = 1 - ratios[..., 1::2]
            flipped[..., 1::2] = 1 - ratios[..., 0::2]
        else:
            raise ValueError(f"Invalid flipping direction '{direction}'")
    ...
    def __call__(self, results):
        ...
        if results['flip']:
            ...
            # flip ratioes
            results['gt_ratios'] = self.ratio_flip(results['gt_ratios'],
                                           results['flip_direction'])
            # flip masks
            for key in results.get('mask_fields', []):
